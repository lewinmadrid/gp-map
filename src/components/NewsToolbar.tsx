  ...
  return (
    <div className="absolute top-4 left-4 right-4 z-30 flex flex-col gap-2">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-sm font-medium text-gray-700 whitespace-nowrap bg-white/60 hover:bg-white px-2 py-1 rounded border border-gray-200 shadow-sm transition-colors">Coverage Filters:</span>
        
        {/* Date Dropdown */}
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="secondary" size="sm" className="h-10 px-3 border border-gray-200 shadow-sm bg-white/60 hover:bg-white text-gray-600 flex items-center gap-1 transition-colors">
        ...
        <Button 
          variant="secondary" 
          size="sm" 
          className={`h-10 w-10 p-0 border shadow-sm transition-colors ${infoMode ? 'bg-blue-100 border-blue-300' : 'bg-white/60 hover:bg-white border-gray-200'}`}
          onClick={() => onInfoModeChange?.(!infoMode)}
        >
          <Info className={`h-4 w-4 ${infoMode ? 'text-blue-700' : 'text-blue-500'}`} />
        </Button>

        <div className="flex items-center gap-1 bg-white/60 hover:bg-white border border-gray-200 rounded-md shadow-sm px-2 h-10 transition-colors">
        ...
        <Button 
          variant="secondary" 
          size="sm" 
          className="h-10 px-3 border border-gray-200 shadow-sm bg-white/60 hover:bg-white text-gray-600 flex items-center gap-1 transition-colors"
          onClick={() => {
        ...
        <Button 
          variant="secondary" 
          size="sm" 
          className="h-10 px-3 border border-gray-200 shadow-sm bg-white/60 hover:bg-white text-gray-600 transition-colors"
          onClick={() => {
        ...
        <Button 
          variant="secondary" 
          size="sm" 
          className={`h-10 px-3 border shadow-sm flex items-center gap-1 transition-colors ${showSecondRow ? 'bg-blue-100 border-blue-300 text-blue-700' : 'bg-white/60 hover:bg-white border-gray-200 text-gray-600'}`}
          onClick={() => {
