      ...
      <DialogContent className="sm:max-w-md" hideOverlay>
        <DialogHeader>
          ...
          <DialogDescription className="text-base pt-2 space-y-3">
            ...
            <p>Please Note: The styles, fonts, icons and map symbology will differ in the production version and the EVAC and NEWS modes show the UI with mostly non-functioning buttons.</p>
          </DialogDescription>
        </DialogHeader>
