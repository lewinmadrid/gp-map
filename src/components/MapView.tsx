...
const MapView = () => {
  ...
  useEffect(() => {
    ...
    if (coverageFilters.bsMc && coverageFilters.bsMc !== 'All') {
      filterConditions.push(['==', ['get', 'bsMc'], coverageFilters.bsMc] as any);
    }
  ...
  // Generate coverage data based on selected date - larger overlapping cells for continuous coverage
  const getCoverageDataForDate = (date: string) => {
    // Base cells with multiple coverage rings (excellent, good, fair) for continuous coverage
    const baseFeatures = [
      // SD-001 - Downtown area with 3 coverage rings
      { cell_id: 'SD-001', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', coords: [[-117.162, 32.732], [-117.156, 32.738], [-117.148, 32.736], [-117.144, 32.730], [-117.146, 32.722], [-117.154, 32.718], [-117.164, 32.720], [-117.168, 32.726], [-117.162, 32.732]], rsrp_class: 'excellent' },
      { cell_id: 'SD-001', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', coords: [[-117.168, 32.742], [-117.155, 32.750], [-117.138, 32.746], [-117.130, 32.734], [-117.134, 32.718], [-117.150, 32.708], [-117.170, 32.712], [-117.180, 32.724], [-117.176, 32.738], [-117.168, 32.742]], rsrp_class: 'good' },
      { cell_id: 'SD-001', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', coords: [[-117.178, 32.755], [-117.158, 32.765], [-117.130, 32.758], [-117.118, 32.742], [-117.122, 32.718], [-117.142, 32.700], [-117.175, 32.702], [-117.192, 32.720], [-117.190, 32.745], [-117.178, 32.755]], rsrp_class: 'fair' },
      
      // SD-002 - East side with 3 coverage rings
      { cell_id: 'SD-002', tech: '5G', band: '850', utm: '51', bsMc: 'MC', coords: [[-117.122, 32.730], [-117.116, 32.736], [-117.108, 32.734], [-117.104, 32.728], [-117.106, 32.720], [-117.114, 32.716], [-117.124, 32.718], [-117.128, 32.724], [-117.122, 32.730]], rsrp_class: 'excellent' },
      { cell_id: 'SD-002', tech: '5G', band: '850', utm: '51', bsMc: 'MC', coords: [[-117.130, 32.742], [-117.118, 32.752], [-117.100, 32.748], [-117.090, 32.734], [-117.094, 32.716], [-117.112, 32.704], [-117.134, 32.708], [-117.144, 32.724], [-117.140, 32.740], [-117.130, 32.742]], rsrp_class: 'good' },
      { cell_id: 'SD-002', tech: '5G', band: '850', utm: '51', bsMc: 'MC', coords: [[-117.142, 32.758], [-117.122, 32.770], [-117.092, 32.762], [-117.076, 32.742], [-117.080, 32.712], [-117.104, 32.694], [-117.144, 32.698], [-117.162, 32.720], [-117.158, 32.750], [-117.142, 32.758]], rsrp_class: 'fair' },
      
      // SD-003 - South area with 3 coverage rings
      { cell_id: 'SD-003', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', coords: [[-117.172, 32.710], [-117.166, 32.716], [-117.158, 32.714], [-117.154, 32.708], [-117.156, 32.700], [-117.164, 32.696], [-117.174, 32.698], [-117.178, 32.704], [-117.172, 32.710]], rsrp_class: 'excellent' },
      { cell_id: 'SD-003', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', coords: [[-117.180, 32.722], [-117.168, 32.732], [-117.150, 32.728], [-117.140, 32.714], [-117.144, 32.696], [-117.162, 32.684], [-117.184, 32.688], [-117.194, 32.704], [-117.190, 32.720], [-117.180, 32.722]], rsrp_class: 'good' },
      { cell_id: 'SD-003', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', coords: [[-117.192, 32.735], [-117.172, 32.750], [-117.142, 32.742], [-117.125, 32.722], [-117.130, 32.694], [-117.156, 32.674], [-117.196, 32.680], [-117.212, 32.702], [-117.206, 32.728], [-117.192, 32.735]], rsrp_class: 'fair' },
      
      // SD-004 - North area with 2 coverage rings
      { cell_id: 'SD-004', tech: '5G', band: '700', utm: '51', bsMc: 'MC', coords: [[-117.192, 32.745], [-117.184, 32.752], [-117.174, 32.750], [-117.170, 32.742], [-117.174, 32.734], [-117.184, 32.732], [-117.194, 32.736], [-117.198, 32.742], [-117.192, 32.745]], rsrp_class: 'good' },
      { cell_id: 'SD-004', tech: '5G', band: '700', utm: '51', bsMc: 'MC', coords: [[-117.205, 32.762], [-117.185, 32.775], [-117.162, 32.768], [-117.152, 32.752], [-117.158, 32.730], [-117.180, 32.718], [-117.208, 32.724], [-117.220, 32.745], [-117.215, 32.760], [-117.205, 32.762]], rsrp_class: 'fair' },
    ];

    const additionalCells: Record<string, any[]> = {
      '08-12-2025': [
        { cell_id: 'SD-005', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.145, 32.718], [-117.138, 32.725], [-117.128, 32.722], [-117.124, 32.714], [-117.128, 32.705], [-117.140, 32.702], [-117.150, 32.707], [-117.152, 32.714], [-117.145, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-005', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.155, 32.732], [-117.140, 32.742], [-117.118, 32.736], [-117.108, 32.720], [-117.115, 32.700], [-117.138, 32.690], [-117.162, 32.698], [-117.170, 32.716], [-117.162, 32.730], [-117.155, 32.732]], rsrp_class: 'good' },
        { cell_id: 'SD-006', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.195, 32.718], [-117.186, 32.726], [-117.174, 32.723], [-117.170, 32.714], [-117.175, 32.705], [-117.188, 32.702], [-117.200, 32.708], [-117.202, 32.715], [-117.195, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-006', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.208, 32.732], [-117.190, 32.745], [-117.168, 32.738], [-117.158, 32.720], [-117.166, 32.698], [-117.192, 32.688], [-117.218, 32.700], [-117.225, 32.720], [-117.216, 32.732], [-117.208, 32.732]], rsrp_class: 'good' },
      ],
      '07-12-2025': [
        { cell_id: 'SD-005', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.145, 32.718], [-117.138, 32.725], [-117.128, 32.722], [-117.124, 32.714], [-117.128, 32.705], [-117.140, 32.702], [-117.150, 32.707], [-117.152, 32.714], [-117.145, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-005', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.155, 32.732], [-117.140, 32.742], [-117.118, 32.736], [-117.108, 32.720], [-117.115, 32.700], [-117.138, 32.690], [-117.162, 32.698], [-117.170, 32.716], [-117.162, 32.730], [-117.155, 32.732]], rsrp_class: 'good' },
        { cell_id: 'SD-006', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.195, 32.718], [-117.186, 32.726], [-117.174, 32.723], [-117.170, 32.714], [-117.175, 32.705], [-117.188, 32.702], [-117.200, 32.708], [-117.202, 32.715], [-117.195, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-007', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', coords: [[-117.148, 32.752], [-117.138, 32.760], [-117.125, 32.756], [-117.120, 32.746], [-117.126, 32.736], [-117.140, 32.734], [-117.152, 32.740], [-117.155, 32.748], [-117.148, 32.752]], rsrp_class: 'excellent' },
        { cell_id: 'SD-007', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', coords: [[-117.158, 32.768], [-117.138, 32.780], [-117.112, 32.772], [-117.102, 32.754], [-117.110, 32.730], [-117.135, 32.720], [-117.165, 32.728], [-117.175, 32.750], [-117.168, 32.766], [-117.158, 32.768]], rsrp_class: 'good' },
        { cell_id: 'SD-008', tech: '5G', band: '850', utm: '51', bsMc: 'MC', coords: [[-117.102, 32.715], [-117.094, 32.722], [-117.084, 32.718], [-117.080, 32.710], [-117.085, 32.702], [-117.096, 32.700], [-117.106, 32.705], [-117.108, 32.712], [-117.102, 32.715]], rsrp_class: 'excellent' },
        { cell_id: 'SD-008', tech: '5G', band: '850', utm: '51', bsMc: 'MC', coords: [[-117.115, 32.730], [-117.098, 32.742], [-117.075, 32.735], [-117.065, 32.718], [-117.072, 32.696], [-117.098, 32.686], [-117.122, 32.695], [-117.130, 32.715], [-117.122, 32.728], [-117.115, 32.730]], rsrp_class: 'good' },
      ],
      '06-12-2025': [
        { cell_id: 'SD-005', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.145, 32.718], [-117.138, 32.725], [-117.128, 32.722], [-117.124, 32.714], [-117.128, 32.705], [-117.140, 32.702], [-117.150, 32.707], [-117.152, 32.714], [-117.145, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-006', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.195, 32.718], [-117.186, 32.726], [-117.174, 32.723], [-117.170, 32.714], [-117.175, 32.705], [-117.188, 32.702], [-117.200, 32.708], [-117.202, 32.715], [-117.195, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-007', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', coords: [[-117.148, 32.752], [-117.138, 32.760], [-117.125, 32.756], [-117.120, 32.746], [-117.126, 32.736], [-117.140, 32.734], [-117.152, 32.740], [-117.155, 32.748], [-117.148, 32.752]], rsrp_class: 'excellent' },
        { cell_id: 'SD-008', tech: '5G', band: '850', utm: '51', bsMc: 'MC', coords: [[-117.102, 32.715], [-117.094, 32.722], [-117.084, 32.718], [-117.080, 32.710], [-117.085, 32.702], [-117.096, 32.700], [-117.106, 32.705], [-117.108, 32.712], [-117.102, 32.715]], rsrp_class: 'excellent' },
        { cell_id: 'SD-009', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', coords: [[-117.168, 32.765], [-117.155, 32.775], [-117.140, 32.770], [-117.134, 32.758], [-117.140, 32.746], [-117.158, 32.742], [-117.172, 32.750], [-117.176, 32.760], [-117.168, 32.765]], rsrp_class: 'good' },
        { cell_id: 'SD-010', tech: '5G', band: '700', utm: '51', bsMc: 'MC', coords: [[-117.225, 32.738], [-117.212, 32.750], [-117.195, 32.745], [-117.188, 32.732], [-117.195, 32.718], [-117.215, 32.714], [-117.232, 32.724], [-117.235, 32.735], [-117.225, 32.738]], rsrp_class: 'good' },
      ],
      '05-12-2025': [
        { cell_id: 'SD-005', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.145, 32.718], [-117.138, 32.725], [-117.128, 32.722], [-117.124, 32.714], [-117.128, 32.705], [-117.140, 32.702], [-117.150, 32.707], [-117.152, 32.714], [-117.145, 32.718]], rsrp_class: 'excellent' },
        { cell_id: 'SD-006', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.195, 32.718], [-117.186, 32.726], [-117.174, 32.723], [-117.170, 32.714], [-117.175, 32.705], [-117.188, 32.702], [-117.200, 32.708], [-117.202, 32.715], [-117.195, 32.718]], rsrp_class: 'excellent' },
        ...
        { cell_id: 'SD-009', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', coords: [[-117.168, 32.765], [-117.155, 32.775], [-117.140, 32.770], [-117.134, 32.758], [-117.140, 32.746], [-117.158, 32.742], [-117.172, 32.750], [-117.176, 32.760], [-117.168, 32.765]], rsrp_class: 'good' },
        { cell_id: 'SD-010', tech: '5G', band: '700', utm: '51', bsMc: 'MC', coords: [[-117.225, 32.738], [-117.212, 32.750], [-117.195, 32.745], [-117.188, 32.732], [-117.195, 32.718], [-117.215, 32.714], [-117.232, 32.724], [-117.235, 32.735], [-117.225, 32.738]], rsrp_class: 'good' },
        { cell_id: 'SD-011', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.182, 32.695], [-117.172, 32.704], [-117.160, 32.700], [-117.155, 32.690], [-117.162, 32.680], [-117.176, 32.678], [-117.188, 32.685], [-117.190, 32.693], [-117.182, 32.695]], rsrp_class: 'excellent' },
        { cell_id: 'SD-011', tech: 'LTE', band: '850', utm: '50', bsMc: 'BS', coords: [[-117.195, 32.710], [-117.175, 32.725], [-117.150, 32.718], [-117.140, 32.698], [-117.150, 32.675], [-117.180, 32.668], [-117.205, 32.680], [-117.212, 32.700], [-117.202, 32.712], [-117.195, 32.710]], rsrp_class: 'good' },
        { cell_id: 'SD-012', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.092, 32.745], [-117.082, 32.754], [-117.070, 32.750], [-117.065, 32.740], [-117.072, 32.730], [-117.085, 32.728], [-117.096, 32.734], [-117.098, 32.742], [-117.092, 32.745]], rsrp_class: 'excellent' },
        { cell_id: 'SD-012', tech: '5G', band: '1900', utm: '51', bsMc: 'MC', coords: [[-117.105, 32.762], [-117.085, 32.775], [-117.060, 32.768], [-117.048, 32.750], [-117.058, 32.725], [-117.085, 32.715], [-117.112, 32.725], [-117.122, 32.748], [-117.115, 32.762], [-117.105, 32.762]], rsrp_class: 'good' },
      ],
    };
      ...
      try {
        ...
        const cellTowerData = {
          ...
          features: [
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-001', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', signal_strength: -65, rsrp_class: 'excellent' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-001', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', signal_strength: -85, rsrp_class: 'good' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-001', tech: 'LTE', band: '700', utm: '50', bsMc: 'BS', signal_strength: -100, rsrp_class: 'fair' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-002', tech: '5G', band: '850', utm: '51', bsMc: 'MC', signal_strength: -60, rsrp_class: 'excellent' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-002', tech: '5G', band: '850', utm: '51', bsMc: 'MC', signal_strength: -80, rsrp_class: 'good' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-002', tech: '5G', band: '850', utm: '51', bsMc: 'MC', signal_strength: -95, rsrp_class: 'fair' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-003', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', signal_strength: -62, rsrp_class: 'excellent' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-003', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', signal_strength: -82, rsrp_class: 'good' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-003', tech: 'LTE', band: '1900', utm: '50', bsMc: 'BS', signal_strength: -98, rsrp_class: 'fair' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
            ...
            {
              type: 'Feature',
              properties: { cell_id: 'SD-004', tech: '5G', band: '700', utm: '51', bsMc: 'MC', signal_strength: -105, rsrp_class: 'poor' },
              geometry: {
                type: 'Polygon',
                coordinates: [[
